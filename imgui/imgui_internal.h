...
#define IM_TRUNC(_VAL)                  ((float)(int)(_VAL))           // ImFloor() is not inlined in MSVC debug builds
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImVec2                  Pos;     
    ImGuiChildFlags         ChildFlags;   // Position (always rounded-up to nearest pixel)
    ...
    bool                    HasCloseButton;      
    signed char             ResizeBorderHovered;    // Set when the window has a close button (p_open != NULL)
...
//#endif
    ...
    IMGUI_API bool          ButtonExPOS(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
